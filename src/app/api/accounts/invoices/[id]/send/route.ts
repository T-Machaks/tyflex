...
export async function POST(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    await sendMailWithAttachment({
      ...
      subject: `Tyflex — Invoice ${invoice.invoiceNumber}`,
      html: `<p>Dear ${invoice.client.contactName},</p><p>Please find attached invoice ${invoice.invoiceNumber} from Tyflex.</p>${renderKeyValueHtml(rows)}<p>Thank you for your business.</p>`,
      text: `Dear ${invoice.client.contactName},\n\nPlease find attached invoice ${invoice.invoiceNumber} from Tyflex.\n\n${renderKeyValueText(rows)}\n\nThank you for your business.`,
      attachment: {
